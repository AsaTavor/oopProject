class Game {
    ...
    private threeCellArray: Array<ThreeCell>;
    private board: Board;
    constructor() {
        this.cellArray = new Array<Cell>(9);
        for (let i: number = 0; i < 9; i++) {
            this.cellArray[i] = new Cell(i);
        }
        this.threeCellArray = new Array<ThreeCell>(8);
    ...
    public checkIfWin(): boolean {
        for (let i: number = 0; i < this.threeCellArray.length; i++) {
